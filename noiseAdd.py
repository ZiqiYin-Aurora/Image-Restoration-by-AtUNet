...
if __name__ == '__main__':
    noise, out = gasuss_noise("../dataset/train_data/84.jpg", mean=0, var=0.01)
    # cv2.imshow('clean img', '../dataset/simple_train_data/71.jpg')
    ...
    cv2.imwrite('../essay/g_noise.png', noise)
    cv2.imshow('noisy img', out)
    cv2.imwrite('../essay/g_noisy_img.png', out)
    cv2.waitKey(0)